...
conn.bye = '-------------------------------------------------\n┣・🧸 @user\n┣・🧸TANY BOT 𝙏𝙀 𝙃𝘼𝘾𝙀 𝙇𝘼 𝘾𝙊𝙍𝘿𝙄𝘼𝙇 𝘿𝙀𝙎𝙋𝙀𝘿𝙄𝘿𝘼 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊, 𝙃𝘼𝙎𝙏𝘼 𝙋𝙍𝙊𝙉𝙏𝙊🧸❤\n\n┣・ *𝙔𝘼 𝙉𝙊 𝙁𝙊𝙍𝙈𝘼𝙎 𝙋𝘼𝙍𝙏𝙀 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊*\n┣・ *TANY BOT*\n-------------------------------------------------'
conn.spromote = '❗ *TANY BOT* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀  @user 𝙀𝙎 𝙐𝙉 𝙉𝙐𝙀𝙑𝙊 𝘼𝘿𝙈𝙄𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊\n\n*𝙔𝘼 𝙏𝙄𝙀𝙉𝙀𝙎 𝙇𝙊𝙎 𝙋𝙊𝘿𝙀𝙍𝙀𝙎 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉*'
conn.sdemote = '❗ *TANY BOT* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 @user 𝙔𝘼 𝙉𝙊 𝙀𝙎 𝙐𝙉 𝘼𝘿𝙈𝙄𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊\n\n*𝙔𝘼 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀𝙎 𝙇𝙊𝙎 𝙋𝙊𝘿𝙀𝙍𝙀𝙎 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉*'
conn.sDesc = '❗ *TANY BOT* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙇𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n ✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅\n*𝙉𝙐𝙀𝙑𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉:* @desc'
conn.sSubject = '❗ *TANY BOT* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙀𝙇 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅\n*𝙉𝙐𝙀𝙑𝙊 𝙉𝙊𝙈𝘽𝙍𝙀:* @subject'
conn.sIcon = '❗ *TANY BOT* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n\n*✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅*'
conn.sRevoke = '*❗TANY BOT 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙃𝘼 𝘼𝘾𝙏𝙐𝘼𝙇𝙄𝙕𝘼𝘿𝙊 𝙀𝙇 𝙇𝙄𝙉𝙆 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊✅\n*𝙉𝙐𝙀𝙑𝙊 𝙇𝙄𝙉𝙆:* @revoke'
...
setInterval(async () => {
  ...
  const bio = `🚀 TANY BOT +51 917 518 909 ⦙⦙ 💻 𝙊𝙉𝙇𝙄𝙉𝙀 𝙁𝘼𝙎𝙏 ${uptime}`;
